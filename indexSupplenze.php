...
<body>
    ...
    <div class="container">
        <h2 class="mt-2">Supplenze</h2>
        <div class="row">

            <form action="./indexSupplenze.php" method="post">
                <div class="row mb-3">
                    <div class="col-3">
                        <select class="form-select" id="cercasupplenze" name="cercasupplenze" required>
                            <option value="">Seleziona</option>
                            <option value="1" <?php
if ($_POST['cercasupplenze'] == '1')
    echo "selected";
?>>Una supplenza nella stagione corrente</option>
                            <option value="2" <?php
if ($_POST['cercasupplenze'] == '2')
    echo "selected";
?>>Non più di due supplenze nella stagione corrente</option>
                            <option value="3" <?php
if ($_POST['cercasupplenze'] == '3')
    echo "selected";
?>>Più di due supplenze nella stagione corrente</option>
                        </select>
                    </div>
                    <div class="col-3">
            ...
            <div class="col">
                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                    <!--ADD BUTTON / aggiungi nuova supplenza al db-->
                    <button class="btn btn-primary" type="button" onclick="goToAddSupplenzaPage()">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <?php
include 'visualizzaSupplenze.php';
?>
    </div>
    ...
    <script>
    function goToAddSupplenzaPage() {
        window.location.href = "./addSupplenzaPage.php";
    }
    </script>
</body>
