...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-4">
                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                    ...
                    <button class="btn btn-primary" type="button" onclick="goToAddMembro()">
        ...
        <?php
include 'db_conf.php';
include 'visualizzaIscritti.php';
?>
    </div>
    ...
    <script>
    function goToAddMembro() {
        window.location.href = "./addMembroPage.php";
    }
    </script>
</body>
