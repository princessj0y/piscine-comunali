        ...
        <div class="row">
            ...
            <div class="col-4">
                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                    <!--ADD BUTTON / aggiungi nuova tipologia di corso al db-->
                    <button class="btn btn-primary" type="button" onclick="goToAddTipologiaCorso()">
                    ...
                    <!--ADD BUTTON / aggiungi nuovo corso  al db-->
                    <button class="btn btn-primary" type="button" onclick="goToAddCorso()">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
...
?>
    ...
    <script>
    function goToAddCorso() {
        window.location.href = "./addCorsoPage.php";
    }

    function goToAddTipologiaCorso() {
        window.location.href = "./addTipologiaCorsoPage.php";
    }
    </script>
</body>
